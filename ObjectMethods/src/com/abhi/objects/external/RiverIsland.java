...
public class RiverIsland {
    ...
    public String toString() {
        System.out.println("running toString in RiverIsland");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof RiverIsland) {
            RiverIsland col = (RiverIsland) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("River Island clothes are matching");
                return true;
            }
        }
        return false;
