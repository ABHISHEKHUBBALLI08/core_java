...
public class MarksAndSpencer {
    ...
    public String toString() {
        System.out.println("running toString in MarksAndSpencer");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof MarksAndSpencer) {
            MarksAndSpencer col = (MarksAndSpencer) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("Marks & Spencer clothes are matching");
                return true;
            }
        }
        return false;
