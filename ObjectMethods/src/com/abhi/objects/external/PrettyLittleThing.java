...
public class PrettyLittleThing {
    ...
    public String toString() {
        System.out.println("running toString in PrettyLittleThing");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof PrettyLittleThing) {
            PrettyLittleThing col = (PrettyLittleThing) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("PrettyLittleThing clothes are matching");
                return true;
            }
        }
        return false;
