...
public class Missguided {
    ...
    public String toString() {
        System.out.println("running toString in Missguided");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof Missguided) {
            Missguided col = (Missguided) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("Missguided clothes are matching");
                return true;
            }
        }
        return false;
