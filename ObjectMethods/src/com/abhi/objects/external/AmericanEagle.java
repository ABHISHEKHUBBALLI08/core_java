...
public class AmericanEagle {
    ...
    public String toString() {
        System.out.println("running toString in AmericanEagle");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof AmericanEagle) {
            AmericanEagle col = (AmericanEagle) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("American Eagle clothes are matching");
                return true;
            }
        }
        return false;
