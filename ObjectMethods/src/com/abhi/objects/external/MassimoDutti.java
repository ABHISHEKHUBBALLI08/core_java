...
public class MassimoDutti {
    ...
    public String toString() {
        System.out.println("running toString in MassimoDutti");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof MassimoDutti) {
            MassimoDutti col = (MassimoDutti) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("Massimo Dutti clothes are matching");
                return true;
            }
        }
        return false;
