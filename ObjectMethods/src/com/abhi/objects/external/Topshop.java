...
public class Topshop {
    ...
    public String toString() {
        System.out.println("running toString in Topshop");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof Topshop) {
            Topshop col = (Topshop) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("Topshop clothes are matching");
                return true;
            }
        }
        return false;
