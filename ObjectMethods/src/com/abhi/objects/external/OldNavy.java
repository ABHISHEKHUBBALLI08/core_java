...
public class OldNavy {
    ...
    public String toString() {
        System.out.println("running toString in OldNavy");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof OldNavy) {
            OldNavy col = (OldNavy) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("Old Navy clothes are matching");
                return true;
            }
        }
        return false;
