...
public class BrandyMelville {
    ...
    public String toString() {
        System.out.println("running toString in BrandyMelville");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof BrandyMelville) {
            BrandyMelville col = (BrandyMelville) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("Brandy Melville clothes are matching");
                return true;
            }
        }
        return false;
