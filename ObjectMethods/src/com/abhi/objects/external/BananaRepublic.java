...
public class BananaRepublic {
    ...
    public String toString() {
        System.out.println("running toString in BananaRepublic");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof BananaRepublic) {
            BananaRepublic col = (BananaRepublic) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("Banana Republic clothes are matching");
                return true;
            }
        }
        return false;
