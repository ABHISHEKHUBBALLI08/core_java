...
public class Columbia {
    ...
    public Columbia(String brandName, int foundYr, String brandType, String category) {
    ...
    public String toString() {
        System.out.println("running toString in Columbia");
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj instanceof Columbia) {
            Columbia col = (Columbia) obj;
            if (Objects.equals(col.brandName, this.brandName)) {
                System.out.println("columbia shoes are matching");
                return true;
            }
        }
        return false;
